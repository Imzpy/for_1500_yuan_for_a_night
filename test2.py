...
def find_reg_dep_inst(irsb, target_reg_offset):
    ...
    print("dependencies_idx", dependencies_idx)
    print("interested_value", interested_value)
...
dependencies_addr = find_reg_dep_inst(irsb, archinfo.ArchAArch64().get_register_offset("x8"))
